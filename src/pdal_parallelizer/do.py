...
def splitCopc(filepath, output_dir, json_pipeline, resolution, tile_bounds, nTiles=None, buffer=None, remove_buffer=False):
    ...
    t = tile.Tile(filepath=c.filepath, output_dir=output_dir, json_pipeline=json_pipeline, bounds=c.bounds, buffer=buffer, remove_buffer=remove_buffer)
